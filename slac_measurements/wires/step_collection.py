...
class StepWireMeasurementCollection(BaseWireMeasurementCollection):
    ...
    def _get_step_positions(self) -> list[int]:
    ...
    def _calculate_step_speed(self, position_index: int, positions: list[int]) -> int:
    ...
    def _move_to_step_position(
        ...
        *,
        ...
        self.my_wire.speed = self._calculate_step_speed(position_index, positions)
